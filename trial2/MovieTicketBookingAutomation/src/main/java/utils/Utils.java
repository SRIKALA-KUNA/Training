...
public class Utils {
	...
	public static String movieUrl = prop.getProperty("movies.url");
	public static String locationUrl = prop.getProperty("location.url");
	public static String baseUrl = prop.getProperty("base");
	public static String theaterUrl = prop.getProperty("theater.url");
	public Utils() 
	{
