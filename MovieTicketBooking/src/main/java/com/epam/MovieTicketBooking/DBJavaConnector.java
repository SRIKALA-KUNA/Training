...
public class DBJavaConnector implements DBOperation {
	List<String> location = new ArrayList<String>();
	HashMap<String, List<String>> movie = new HashMap<String, List<String>>();
	HashMap<Object, List<String>> theater = new HashMap<Object, List<String>>();
